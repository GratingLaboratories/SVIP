...
face_cascade = cv2.CascadeClassifier(r"E:\Google Drive\Projects\PyCharm\SVIP\resources\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"E:\Google Drive\Projects\PyCharm\SVIP\resources\haarcascade_eye.xml")
